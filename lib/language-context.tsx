...
const ar: Record<string, string> = {
  ...
  'pricing.title': 'خطط رَوِّج',
  'pricing.subtitle': 'اختر الباقة المناسبة لنموّ متجرك',
  'pricing.tagline': 'رَوِّج — خلّي متجرك يشتغل لحاله',
  'pricing.popular': 'الأفضل',
  'pricing.currency': 'شيكل',
  'pricing.perMonth': 'شهرياً',
  'pricing.cta': 'اختر هذه الباقة',
  'pricing.starter.name': 'ستارت',
  'pricing.starter.subtitle': 'Starter Plan',
  'pricing.starter.f1': '12 بوست',
  'pricing.starter.f2': '2 ريلز',
  'pricing.starter.f3': 'تصميم بسيط',
  'pricing.growth.name': 'جروث',
  'pricing.growth.subtitle': 'Growth Plan',
  'pricing.growth.f1': '+20 بوست',
  'pricing.growth.f2': '5–8 ريلز',
  'pricing.growth.f3': 'إدارة إعلانات',
  'pricing.growth.f4': 'أتمتة الردود',
  'pricing.pro.name': 'برو',
  'pricing.pro.subtitle': 'Pro Plan',
  'pricing.pro.f1': '+30 بوست',
  'pricing.pro.f2': '+10 ريلز',
  'pricing.pro.f3': 'إعلانات متقدمة',
  'pricing.pro.f4': 'أتمتة كاملة',
  'pricing.pro.f5': 'موقع إلكتروني',
...
const en: Record<string, string> = {
  ...
  'pricing.title': 'Rawij Plans',
  'pricing.subtitle': 'Pick the package that fits your store’s growth',
  ...
  'pricing.starter.subtitle': 'Starter Plan',
  'pricing.starter.f1': '12 posts',
  'pricing.starter.f2': '2 reels',
  'pricing.starter.f3': 'Simple design',
  'pricing.growth.name': 'Growth',
  'pricing.growth.subtitle': 'Growth Plan',
  'pricing.growth.f1': '20+ posts',
  'pricing.growth.f2': '5–8 reels',
  'pricing.growth.f3': 'Ads management',
  'pricing.growth.f4': 'Reply automation',
  'pricing.pro.name': 'Pro',
  'pricing.pro.subtitle': 'Pro Plan',
  'pricing.pro.f1': '30+ posts',
  'pricing.pro.f2': '10+ reels',
  'pricing.pro.f3': 'Advanced ads',
  'pricing.pro.f4': 'Full automation',
  'pricing.pro.f5': 'Website included',
