...
const ar: Record<string, string> = {
  ...
  // Rawij Deconstructed (integrated growth system)
  'deconstructed.badge': 'نظام نموّ متكامل',
  'deconstructed.title': 'كل جزء من حضورك الرقمي',
  'deconstructed.titleHighlight': 'مصمَّم ليعمل معاً',
  'deconstructed.description': 'في روّج، لا نصنع منشورات فقط. نبني منظومة رقمية كاملة تربط المحتوى والإعلانات والمواقع والرسائل والأتمتة في تجربة واحدة تساعد مشروعك على النموّ.',
  'deconstructed.feat.1': 'استراتيجية واضحة قبل التنفيذ',
  'deconstructed.feat.2': 'تصميم ومحتوى متناسق',
  'deconstructed.feat.3': 'أتمتة للرسائل والمتابعة',
  'deconstructed.feat.4': 'تحسين مستمر حسب النتائج',
  'deconstructed.cta.start': 'ابدأ مشروعك',
  'deconstructed.cta.services': 'شاهد الخدمات',
  'deconstructed.part.ai.title': 'النواة الذكية',
  'deconstructed.part.ai.label': 'محرّك الاستراتيجية',
  'deconstructed.part.web.title': 'المواقع',
  'deconstructed.part.web.label': 'صفحات الهبوط',
  'deconstructed.part.content.title': 'المحتوى',
  'deconstructed.part.content.label': 'منشورات السوشيال',
  'deconstructed.part.ads.title': 'الإعلانات',
  'deconstructed.part.ads.label': 'إبداعات الحملات',
  'deconstructed.part.automation.title': 'الأتمتة',
  'deconstructed.part.automation.label': 'الردود الذكية',
  'deconstructed.part.analytics.title': 'التحليلات',
  'deconstructed.part.analytics.label': 'تتبّع النموّ',
  'deconstructed.part.messages.title': 'الرسائل',
  'deconstructed.part.messages.label': 'أنظمة الرسائل المباشرة',
...
const en: Record<string, string> = {
  ...
  'deconstructed.badge': 'Integrated Growth System',
  'deconstructed.title': 'Every part of your digital presence',
  'deconstructed.titleHighlight': 'built to work together',
  'deconstructed.description': 'At Rawij, we don’t just create posts. We build a connected digital system that brings content, ads, websites, messaging, and automation into one growth engine for your business.',
  'deconstructed.feat.1': 'Clear strategy before execution',
  'deconstructed.feat.2': 'Cohesive design and content',
  'deconstructed.feat.3': 'Automated messaging & follow-up',
  'deconstructed.feat.4': 'Continuous optimization from data',
  'deconstructed.cta.start': 'Start Your Project',
  'deconstructed.cta.services': 'View Services',
  'deconstructed.part.ai.title': 'AI Core',
  'deconstructed.part.ai.label': 'Strategy Engine',
  'deconstructed.part.web.title': 'Website',
  'deconstructed.part.web.label': 'Landing Pages',
  'deconstructed.part.content.title': 'Content',
  'deconstructed.part.content.label': 'Social Posts',
  'deconstructed.part.ads.title': 'Ads',
  'deconstructed.part.ads.label': 'Campaign Creatives',
  'deconstructed.part.automation.title': 'Automation',
  'deconstructed.part.automation.label': 'Smart Replies',
  'deconstructed.part.analytics.title': 'Analytics',
  'deconstructed.part.analytics.label': 'Growth Tracking',
  'deconstructed.part.messages.title': 'Messages',
  'deconstructed.part.messages.label': 'DM Systems',
